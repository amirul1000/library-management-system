...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="component"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/component/index'); ?>"><i class="icon_table"></i>Component</a></li>
<li <?php if($this->router->fetch_class()=="issued"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/issued/index'); ?>"><i class="icon_table"></i>Issued</a></li>
