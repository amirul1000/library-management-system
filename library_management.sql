...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2020 at 03:26 PM
...
CREATE TABLE `component` (
  ...
  `component_type` enum('book','paper','research paper','magazine') NOT NULL,
  `author` varchar(127) NOT NULL,
  `entry_date` date NOT NULL,
  `description` text NOT NULL,
  `status` enum('active','inactive','lost','expired') NOT NULL
...
CREATE TABLE `issued` (
  `id` int(10) NOT NULL,
  `collector_users_id` int(10) NOT NULL,
  `issued_by_users_id` int(10) DEFAULT NULL,
...
(12, 'abc2@abc.com', '123456', 'Mr.', 'Patel', 'Jon', NULL, '565656', '0000-00-00', 'Pata Corporation', 'C-20,JAkir Hossain Road,Block-E, Md-pur', 'Dhaka', 'Dhaka Division', '1212', '19', '2020-07-04 11:34:29', NULL, 'staff', 'active');
